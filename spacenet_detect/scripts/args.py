...
def get_main_args():
    ...
    arg ("--seed", type=int, default=2000, help="Random Seed")
    arg("--generator", default=torch.Generator().manual_seed(2000), help='Train Validate Predict Seed')
    arg("--base_dir", type=str, default="./data", help="Data Directory")
    arg ("--num_workers", type=int, default=12, help="DataLoader num_workers")
    ...
    # arg ("--strides",  default=[[1, 1]] * 5, help="Convolution Strides")
    arg ("--kernels",  default=[[3, 3]] * 5, help="Convolution Kernels")
    ...
    arg("--ckpt_path", type=str, default="./checkpoints", help='Checkpoint Path')
    arg("--save_path", type=str, default='./checkpoints/save', help='Saves Path')
