...
class NeuralProcessImg(nn.Module):
    ...
    def forward(self, x_context, y_context, x_target, y_target):
        """
        Given x and y tensors expected by Neural Process. Specifically, 
        x will contain indices of unmasked points, e.g.
        ...
        It returns a distribution over pixel intensities at the target points.
